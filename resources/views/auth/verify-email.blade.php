<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600">
        {{ __('მადლობა რეგისტრაციის გავლისთვის! კალათაში პროდუქციის ჩამატებამდე, გთხოვთ დაადასტუროთ თქვენი ელფოსტაზე გამოგზავნილი ბმულზე ერთი დაწკაპუნებით, რომელიც ახლახან გამოგიგზავნეთ. თუ ელფოსტა არ მიგიღიათ, ჩვენ სიამოვნებით გამოგიგზავნით სხვას.') }}
    </div>
