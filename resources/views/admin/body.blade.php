{{-- <h2 class="h5 no-margin-bottom">თქვენი პანელი</h2> --}}
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="fa-light fa-brush" style="color: #70777d;"></i></i></div><strong>პროდუქციის რაოდენობა</strong>
                    </div>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="fa-light fa-cart-shopping" style="color: #70777d;"></i></div><strong>შეკვეთების რაოდენობა</strong>
                    </div>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="fa-light fa-truck-fast" style="color: #70777d;"></i></div><strong>მიტანილი პროდუქცია</strong>
                    </div>
